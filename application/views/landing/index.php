...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="<?= base_url('assets/assets_landing/favicon.ico') ?>" />
    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="<?= base_url('assets/assets_landing/img/avataaars.svg')?>" alt="..." />
                <!-- Masthead Heading-->
