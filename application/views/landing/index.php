...
<head>
    ...
    <link href="<?= base_url('assets/assets_landing/css/styles.css') ?>" rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top">AR Event Organizer</a>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="<?= base_url('assets/assets_landing/img/LogoPemweb.png') ?>" alt="..." />
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">AR Event Organizer</h1>
            <!-- Icon Divider-->
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <?php foreach ($kegiatan as $k): ?>
                    ...
                    <!-- Portfolio Modal -->
                    <div class="portfolio-modal modal fade" id="portfolioModal<?= $k->id ?>" tabindex="-1" aria-labelledby="portfolioModal<?= $k->id ?>" aria-hidden="true">
                                    ...
                                    <div class="container">
                                        <div class="row justify-content-center">
                                            <div class="col">
                                                ...
                                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0" style="font-size: 33px;"><?= $k->judul ?></h2>
                                                <!-- Icon Divider-->
                                                <div class="divider-custom">
                                                    <div class="divider-custom-line"></div>
                                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
    ...
    <!-- Core theme JS-->
    <script src="<?= base_url('assets/assets_landing/js/scripts.js') ?>"></script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
